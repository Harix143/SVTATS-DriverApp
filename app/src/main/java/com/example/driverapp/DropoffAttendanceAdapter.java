...
public class DropoffAttendanceAdapter extends RecyclerView.Adapter<StudentViewHolder> {

    ArrayList<StudentModel> data;
    Context context;


    public DropoffAttendanceAdapter(ArrayList<StudentModel> data, Context context) {
        this.data = data;
